...
(1, 'alice@example.com', 'alice', 'Alice Nguyen', 4, 1, '2025-10-22 19:01:29'),
(2, 'bob@example.com', 'bob', 'Bob Tran', 4, 2, '2025-10-22 19:01:29'),
(3, 'carol@example.com', 'carol', 'Carol Pham', 2, 4, '2025-10-22 19:01:29'),
(4, 'david@example.com', 'david', 'David Le', 1, 5, '2025-10-22 19:01:29'),
(5, 'erin@example.com', 'erin', 'Erin Ho', 3, 3, '2025-10-22 19:01:29');
...
(1, 'HashMap không đồng bộ, Hashtable có.', 1, 1),
(2, 'Giống nhau.', 1, 0),
(3, 'CLR là runtime, CTS là kiểu dữ liệu.', 2, 1),
(4, 'SELECT TOP 5 theo doanh số.', 3, 1),
(5, 'Pre-request chạy sau request.', 4, 0);
...
(1, 'EX-JA-01', 'Java Core Basics', 1, 60, 1, '2025-10-22 19:01:29'),
(2, 'EX-DN-01', '.NET Fundamentals', 2, 60, 3, '2025-10-22 19:01:29'),
(3, 'EX-SQL-01', 'SQL Practice', 3, 45, 2, '2025-10-22 19:01:29'),
(4, 'EX-PS-01', 'Postman Basics', 4, 30, 5, '2025-10-22 19:01:29'),
(5, 'EX-RB-01', 'Ruby Essentials', 5, 45, 4, '2025-10-22 19:01:29');
...
(1, 'G-Alpha', 1, '2025-10-22 19:01:29'),
(2, 'G-Beta', 2, '2025-10-22 19:01:29'),
(3, 'G-Gamma', 3, '2025-10-22 19:01:29'),
(4, 'G-Delta', 4, '2025-10-22 19:01:29'),
(5, 'G-Epsilon', 5, '2025-10-22 19:01:29');
...
(1, 'Java: Khác nhau giữa HashMap và Hashtable?', 1, 1, 1, '2025-10-22 19:01:29'),
(2, '.NET: Giải thích CLR và CTS.', 2, 4, 3, '2025-10-22 19:01:29'),
(3, 'SQL: Viết truy vấn lấy top 5 doanh số.', 3, 2, 2, '2025-10-22 19:01:29'),
(4, 'Postman: Cách dùng pre-request script.', 4, 2, 5, '2025-10-22 19:01:29'),
(5, 'Ruby: Khối (block) và Proc khác gì?', 5, 1, 4, '2025-10-22 19:01:29');
